 ...
 * /java/org/apache/commons/httpclient/methods/multipart/MultipartRequestEntity.java,v 1.1
 * 2004/10/06 03:39:59 mbecke Exp $
 * $Revision: 502647 $
 ...
 * href="http://www.ietf.org/rfc/rfc1867.txt">RFC1867</a>: <blockquote> The media-type
 * multipart/form-data follows the rules of all multipart MIME data streams as outlined in RFC 1521.
 * The multipart/form-data contains a series of parts. Each part is expected to contain a
 * content-disposition header where the value is "form-data" and a name attribute specifies the
 * field name within the form, e.g., 'content-disposition: form-data; name="xxxxx"', where xxxxx is
 * the field name corresponding to that field. Field names originally in non-ASCII character sets
 * may be encoded using the method outlined in RFC 1522. </blockquote>
 * </p>
 * <p>
 * This entity is designed to be used in conjunction with the {@link org.apache.http.HttpRequest} to
 ...
 * Part[] parts = {
 *     new StringPart(&quot;param_name&quot;, &quot;value&quot;), new FilePart(f.getName(), f)
 * };
...
public class MultipartEntity extends AbstractHttpEntity {
  ...
  public void appendPart(Part[] newParts) {
    ...
    final Part[] oldParts = parts;
    parts = new Part[oldParts.length + newParts.length];
    System.arraycopy(oldParts, 0, parts, 0, oldParts.length);
    System.arraycopy(newParts, 0, parts, oldParts.length, newParts.length);
  }
