 ...
 * /java/org/apache/commons/httpclient/methods/multipart/Part.java,v 1.16 2005/01/14 21:16:40 olegk
 * Exp $
 * $Revision: 480424 $
...
public abstract class Part {
  ...
  // private final static String LOG_TAG = "Part";
  ...
  /**
   * The default boundary to be used if {@link #setPartBoundary(byte[])} has
   * not been called.
   */
  ...
  protected void sendStart(OutputStream out) throws IOException {
    // Log.v(LOG_TAG, "enter sendStart(OutputStream out)");
  ...
  protected void sendDispositionHeader(OutputStream out) throws IOException {
    // Log.v(LOG_TAG, "enter sendDispositionHeader(OutputStream out)");
  ...
  protected void sendContentTypeHeader(OutputStream out) throws IOException {
    // Log.v(LOG_TAG, "enter sendContentTypeHeader(OutputStream out)");
  ...
  protected void sendTransferEncodingHeader(OutputStream out)
      throws IOException {
    // Log.v(LOG_TAG, "enter sendTransferEncodingHeader(OutputStream out)");
  ...
  protected void sendEndOfHeader(OutputStream out) throws IOException {
    // Log.v(LOG_TAG, "enter sendEndOfHeader(OutputStream out)");
    out.write(CRLF_BYTES);
    out.write(CRLF_BYTES);
  }
  ...
  protected void sendEnd(OutputStream out) throws IOException {
    // Log.v(LOG_TAG, "enter sendEnd(OutputStream out)");
    out.write(CRLF_BYTES);
  }
  ...
  public void send(OutputStream out) throws IOException {
    // Log.v(LOG_TAG, "enter send(OutputStream out)");
    sendStart(out);
  ...
  public static long getLengthOfParts(Part[] parts, byte[] partBoundary)
      throws IOException {
    // Log.v(LOG_TAG, "getLengthOfParts(Parts[])");
    if (parts == null) {
      throw new IllegalArgumentException("Parts may not be null");
    }
    long total = 0;
