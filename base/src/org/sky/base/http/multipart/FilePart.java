 ...
 * /java/org/apache/commons/httpclient/methods/multipart/FilePart.java,v 1.19 2004/04/18 23:51:37
 * jsdever Exp $
 * $Revision: 480424 $
...
public class FilePart extends PartBase {
   ...
   * @throws FileNotFoundException if the <i>file</i> is not a normal file or
  ...
  public FilePart(String name, String fileName, byte[] data,
    ...
    this(name, new ByteArrayPartSource(fileName, data), contentType,
        charset);
  }
  ...
  protected PartSource getSource() {
    // Log.v("FilePart", "enter getSource()");
    return this.source;
  }
  ...
  protected long lengthOfData() {
    // Log.v("FilePart", "enter lengthOfData()");
